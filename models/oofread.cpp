...
nIndent = 0;
OOF_PrintLog ("\nreading %s/%s\n", bCustom ? gameFolders.mods.szModels [0] : gameFolders.game.szModels, filename);
if (!(*filename && cf.Open (filename, bCustom ? gameFolders.mods.szModels [0] : gameFolders.game.szModels, "rb", 0))) {
