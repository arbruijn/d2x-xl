...
if (m_nObject >= 0) {
	if ((gameData.objs.viewerP != gameData.Object (m_nObject)) || SPECTATOR (gameData.objs.viewerP))
		m_pos = gameData.Object (m_nObject)->FrontPosition ();
	else {
		p [0].Set (0, 0, gameData.Object (m_nObject)->Size ());
		bTransform = false;
		}
	}
