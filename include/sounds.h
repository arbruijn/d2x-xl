...
#define D1_SOUND_AMBIENT_LAVA                   151
#define D2_SOUND_AMBIENT_LAVA                   222
#define SOUND_AMBIENT_WATER							223

#define SOUND_AMBIENT_LAVA		(gameStates.app.bD1Mission ? D1_SOUND_AMBIENT_LAVA : D2_SOUND_AMBIENT_LAVA)
