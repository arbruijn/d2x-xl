...
void NDRecordWallHitProcess( int nSegment, int CSide, int damage, int playernum );
void NDRecordTrigger( int nSegment, int CSide, int nObject,int shot );
...
void NDRecordWallToggle(int nSegment, int CSide );
...
void NDRecordWallSetTMapNum1(short seg,ubyte CSide,short cseg,ubyte cside,short tmap);
void NDRecordWallSetTMapNum2(short seg,ubyte CSide,short cseg,ubyte cside,short tmap);
...
void NDRecordDoorOpening(int nSegment, int CSide);
