...
public:
	...
	int AddCheck(const char* szId, const char* szText, int nValue,
			int nKey = 0, const char* szHelp = NULL);
	int AddRadio(const char* szId, const char* szText, int nValue,
			int nKey = 0, const char* szHelp = NULL);
	int AddMenu(const char* szId, const char* szText, int nKey = 0,
			const char* szHelp = NULL);
	int AddText(const char* szId, const char* szText, int nKey = 0);
	int AddSlider(const char* szId, const char* szText, int nValue, int nMin,
			int nMax, int nKey = 0, const char* szHelp = NULL);
	int AddInput(const char* szId, const char* szText, int nLen,
			const char* szHelp = NULL);
	int AddInput(const char* szId, const char* szText, char* szValue, int nLen,
			const char* szHelp = NULL);
	int AddInput(const char* szId, const char* szText, char* szValue,
			int nValue, int nLen, const char* szHelp = NULL);
	int AddInputBox(const char* szId, const char* szText, int nLen, int nKey =
			0, const char* szHelp = NULL);
	int AddNumber(const char* szId, const char* szText, int nValue, int nMin,
			int nMax);
	...
	void FadeIn(void);
	void FadeOut(const char* pszTitle = NULL, const char* pszSubTitle = NULL,
			CCanvas* gameCanvasP = NULL);
