...
int StateSaveAll (int betweenLevels, int bSecretSave, int bQuick, const char *pszFilenameOverride);
int StateRestoreAll (int in_game, int bSecretRestore, int bQuick, const char *pszFilenameOverride);
