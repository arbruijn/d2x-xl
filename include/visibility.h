...
int32_t CanSeePoint (CObject *objP, CFixVector *vSource, CFixVector *vDest, int16_t nSegment, fix xRad = 0, int32_t nThread = MAX_THREADS);

int32_t CanSeeObject (int32_t nObject, int32_t bCheckObjs, int32_t nThread = MAX_THREADS);

int32_t ObjectToObjectVisibility (CObject *objP1, CObject *objP2, int32_t transType, int32_t nThread = MAX_THREADS);
