...
#define TXT_MT_STATIC_LIGHT		GT(1060)
#define TXT_MT_DYN_LIGHT			GT(1061)
#define TXT_MT_FACE_SORT			GT(1062)
#define TXT_MT_SEG_SORT_PREPROCESS	GT(1063)
#define TXT_MT_SEG_SORT				GT(1064)
#define TXT_MT_LIGHTNING_ANIM		GT(1065)
#define TXT_MT_LIGHTING_RENDER	GT(1066)
