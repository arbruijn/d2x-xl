 ...
 * #include <stdio.h> added for FILE nType.
 *
...
char *d2GameTexts [] = {
	...
	"Error initializing selector for tSegment A000.",
...
char *defaultGameTexts [][2] = {
	...
	{"Gib neue Segmentnr. ein:", "Enter new tSegment number:"},
	...
	{"Unzulaessiger Seitentyp in render_side\n(Typ:%i, Segment:%i, Seite:%i)\n", 
	 "Illegal tSide nType in render_side\n(nType; %i, tSegment: %i, tSide:%i)\n"},
	...
	{"L~Ichter/Segment: %d", "l~Ights/tSegment: %d"},
