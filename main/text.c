...
char *defaultHelpTexts [][2] = {
	...
	{"Programmeinstellungen ändern.", "Change program settings."},
	...
	{"Ankreuzen, um Reaktion des Schiffs auf Mausbewegungen zu verstärken.", 
	...
	{"Wenn angekreuzt, erhalten alle Joystickachsen dieselbe Empfindlichkeit und Totzone.\nWenn nicht, können Empfindlichkeit und Totzone individuell fuer jede Joystickachse eingestellt werden.", 
