...
char *baseGameTexts [BASE_TEXT_COUNT][2];
...
const char *defaultGameTexts [][2] = {
 ...
 {"Scheinwerfer ~Verbraucht energie", "~Headlight drains power"},
...
const char *defaultHelpTexts [][2] = {
 ...
 {"Bei verbesserter Kollisionsbehandlung werden korrekte\nAbprallwinkel berechnet. Andernfalls prallen Objekte nach\nKollisionen entgegen ihrer Flugrichtung ab.", 
  "With improved collision handling, correct reflection\nangles are used. Otherwise objects move in their opposite\nflight direction after collisions."},
