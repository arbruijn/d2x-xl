...
const char *defaultGameTexts [][2] = {
 ...
 {"erscheinungseffekt ~Zeigen", "~Warp appearance effect"},
...
const char *defaultHelpTexts [][2] = {
 ...
 {"Wenn angekreuzt, erscheint das Spielerschiff in einer wachsenden Energieblase.", "If checked, player ships spawn in an expanding energy bubble."},
 ...
 {"Hier kann der gewuenschte Spieltyp ausgewaehlt werden.", "Chose the desired type of match here."},
