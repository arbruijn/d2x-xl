...
const char *defaultGameTexts [][2] = {
 ...
 {"VR-Konfiguration", "VR Configuration"},
 {"VR konfigurieren..", "Configure VR..."},
 {"minimal", "minimal"},
 {"maximal", "maximal"},
...
const char *defaultHelpTexts [][2] = {
 ...
 {"Hier kann ein VR konfiguriert werden.", "Configure an VR here."},
 {"Wenn angekreuzt, werden auf dem VR auftretende\nFarbabweichungen korrigiert.", "When checked, chromatic aberrations (color seams) appearing\non the VR are corrected."},
