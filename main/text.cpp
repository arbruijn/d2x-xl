...
const char *defaultGameTexts [][2] = {
 ...
 {"~Explosions-schrapnelle: %s", "~Explosion shrapnels: %s"},
...
const char *defaultHelpTexts [][2] = {
 ...
 {"Wird V-Sync via Treiber angekreuzt, limitiert D2X-XL die Frame-Rate nicht, sondern ueberlaesst das dem Grafiktreiber. Wird es nicht angekreuzt, begrenzt D2X-XL die Frame-Rate auf ca. 60 Hz.",
	 "If V-Sync via driver is checked, D2X-XL doesn't limit the framerate, but leaves this to the graphics driver. If it is not checked, D2X-XL limits the framerate to approx. 60 Hz."},
 ...
 {"Je nach Einstellung sind alle Lichtquellen weiss, nur Waffen geben farbiges Licht, oder alle Lichtquellen leuchten farbig.",
	 "Depending on the setting all light sources are white, only guns emit colored light, or all light sources are colored."},
