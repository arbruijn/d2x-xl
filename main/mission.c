 ...
 * removed return statement in LoadMission so that built in mission will
 * actually set the Current_mission_name and _filename
 *
 * Revision 1.10  1995/01/31  01:19:45  matt
 * Made BuildMissionList() sort missions by name
 *
 * Revision 1.9  1995/01/30  13:49:58  allender
 * changed BuildMissionList in LoadMissionByName to include
 * anarchy levels.
 *
