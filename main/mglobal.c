 ...
 * removed d_malloc of static data now in ai module
 *
 * Revision 1.2  1995/07/12  12:48:52  allender
 * d_malloc out edge_list global here, not static in automap.c
 *
 ...
 * Added gameData.app.nFrameCount variable
 *
 ...
 * Add Classes, Class_views, gameData.objs.objects
 *
 * Revision 1.10  1993/11/04  18:52:36  matt
 * Made gameData.segs.vertices[] and gameData.segs.points[] use same constant for size, since
 ...
 * Change sideToVerts to use MAX_SIDES_PER_SEGMENT in place of CONNECTIVITY
 *
 * Revision 1.6  1993/10/12  13:57:19  john
 * added texture[]
 *
 * Revision 1.5  1993/10/12  09:58:15  mike
 * Move sideToVerts here from eglobal.c, since it is needed in the game.
 *
