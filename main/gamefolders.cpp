...
if (!(*appConfig.Text ("-datadir") && *CheckFolder (gameFolders.game.szRoot, appConfig.Text ("-datadir"), D2X_APPNAME)) &&
	 !(*appConfig.Text ("-gamedir") && *CheckFolder (gameFolders.game.szRoot, appConfig.Text ("-gamedir"), D2X_APPNAME)) &&
