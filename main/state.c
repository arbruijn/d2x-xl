...
CFWriteByte ((sbyte) netGame.AlwaysLighting, cfp);
...
CFWriteByte ((sbyte) netGame.ShowAllNames, cfp);
...
CFWriteVector (&objP->position.vPos, cfp);     
CFWriteMatrix (&objP->position.mOrient, cfp);  
...
netGame.AlwaysLighting = (ubyte) CFReadByte (cfp);
...
netGame.ShowAllNames = (ubyte) CFReadByte (cfp);
