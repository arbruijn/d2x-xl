...
if (strstr (pszIdent, "Slowmo/Speed"))
	pszIdent = pszIdent;
...
{"gameOptions[0].render.cockpit.nWindowSize=2"},
...
{"gameOptions[0].render.cockpit.bHUD=0"},
...
{"keyboard.Slide left[1].value=-1"},
{"keyboard.Slide right[0].value=77"},
{"keyboard.Slide right[1].value=-1"},
{"keyboard.Slide up[0].value=71"},
{"keyboard.Slide up[1].value=-1"},
{"keyboard.Slide down[0].value=73"},
{"keyboard.Slide down[1].value=-1"},
...
{"joystick.Fire primary[0].value=6"},
{"joystick.Fire secondary[0].value=7"},
...
{"joystick.Pitch U/D[1].value=2"},
{"joystick.Turn L/R[1].value=3"},
...
{"joystick.Cycle Primary[1].value=4"},
{"joystick.Cycle Secondary[1].value=5"},
