...
tParamValue defaultParams [] = {
	...
	{"extraGameInfo[0].bLightTrails", "0"},
	...
	{"gameOptions[0].render.bDynLighting", "1"},
	{"gameOptions[0].render.nDebrisLife", "6"},
	...
	{"gameOptions[0].render.smoke.bSyncSizes", "0"},
	...
	{"extraGameInfo[1].bTripleFusion", "0"},
	...
	{"joystick.Fire primary[0].value", "-75"},
	{"joystick.Fire secondary[0].value", "55"},
