...
tParamValue defaultParams [] = {
	...
	{"keyboard.Pitch forward[0].value", "-1"},
	{"keyboard.Pitch forward[1].value", "-1"},
	{"keyboard.Pitch backward[0].value", "-1"},
	{"keyboard.Pitch backward[1].value", "-1"},
	{"keyboard.Turn left[0].value", "-1"},
	{"keyboard.Turn left[1].value", "-1"},
	{"keyboard.Turn right[0].value", "-1"},
	{"keyboard.Turn right[1].value", "-1"},
	{"keyboard.Slide on[0].value", "-1"},
	{"keyboard.Slide on[1].value", "-1"},
	{"keyboard.Slide left[0].value", "-1"},
	{"keyboard.Slide left[1].value", "75"},
	{"keyboard.Slide right[0].value", "-1"},
	{"keyboard.Slide right[1].value", "77"},
	{"keyboard.Slide up[0].value", "-1"},
	{"keyboard.Slide up[1].value", "71"},
	{"keyboard.Slide down[0].value", "-1"},
	{"keyboard.Slide down[1].value", "73"},
	{"keyboard.Bank on[0].value", "-1"},
	{"keyboard.Bank on[1].value", "-1"},
	{"keyboard.Bank left[0].value", "-1"},
	{"keyboard.Bank left[1].value", "79"},
	{"keyboard.Bank right[0].value", "-1"},
	{"keyboard.Bank right[1].value", "81"},
	...
	{"keyboard.Cruise Faster[0].value", "-56"},
	{"keyboard.Cruise Faster[1].value", "-1"},
	{"keyboard.Cruise Slower[0].value", "-48"},
	...
	{"keyboard.Cycle Primary[0].value", "-1"},
	{"keyboard.Cycle Primary[1].value", "-75"},
	{"keyboard.Cycle Second[0].value", "-1"},
	{"keyboard.Cycle Second[1].value", "55"},
	{"keyboard.Zoom In[0].value", "-1"},
	{"keyboard.Zoom In[1].value", "54"},
