...
gameData.render.vertColor.matAmbient.Blue () = 0.0f; //0.15f; //1.0f - DIFFUSE_LIGHT; //AMBIENT_LIGHT;
...
gameData.render.vertColor.matDiffuse.Blue () = 1.0f; //0.85f; //DIFFUSE_LIGHT;
