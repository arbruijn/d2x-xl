...
int headlightShaderProgs [2] = {-1, -1};
...
//headlights
ogl.m_data.nHeadlights = 0;
if ((headlightShaderProgs [IsMultiGame] < 0) && !InitHeadlightShaders ())
	return -1;
GLhandleARB shaderProg = GLhandleARB (shaderManager.Deploy (headlightShaderProgs [IsMultiGame]));
if (!shaderProg)
	return -1;
...
ogl.ClearError (0);
return headlightShaderProgs [IsMultiGame];
}
