...
{
ENTER (0, 0);
RETVAL (CreateTriangle (pTriangle, index, pFaceTriangle->nFace, pFaceTriangle - TRIANGLES))
}
...
if (lMax <= MAX_EDGE_LEN (m_nQuality))
	RETVAL (-1)
RETVAL (SplitEdge (pFace, &m_edges [pTriangle->lines [h]], nPass))
}
