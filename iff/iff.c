 ...
 * When error, only d_free memory if has been allocated
 *
 ...
 * Added Yuan's code to d_free raw data if we get an error parsing the body
 *
 * Revision 1.7  1993/11/11  12:12:12  yuan
 * Changed d_mallocs to MALLOCs.
 *
