...
if (gameStates.multi.nGameType >= IPX_GAME) {
	...
	pd->objOrient.m.v.r[X] = (fix)INTEL_INT ((int)pd->objOrient.m.v.r[X]);
	pd->objOrient.m.v.r[Y] = (fix)INTEL_INT ((int)pd->objOrient.m.v.r[Y]);
	pd->objOrient.m.v.r[Z] = (fix)INTEL_INT ((int)pd->objOrient.m.v.r[Z]);
	pd->objOrient.m.v.u[X] = (fix)INTEL_INT ((int)pd->objOrient.m.v.u[X]);
	pd->objOrient.m.v.u[Y] = (fix)INTEL_INT ((int)pd->objOrient.m.v.u[Y]);
	pd->objOrient.m.v.u[Z] = (fix)INTEL_INT ((int)pd->objOrient.m.v.u[Z]);
	pd->objOrient.m.v.f[X] = (fix)INTEL_INT ((int)pd->objOrient.m.v.f[X]);
	pd->objOrient.m.v.f[Y] = (fix)INTEL_INT ((int)pd->objOrient.m.v.f[Y]);
	pd->objOrient.m.v.f[Z] = (fix)INTEL_INT ((int)pd->objOrient.m.v.f[Z]);
