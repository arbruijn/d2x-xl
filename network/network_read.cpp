...
if (gameStates.multi.nGameType >= IPX_GAME) {
	...
	pd->objPos.v.c.x = INTEL_INT (pd->objPos.v.c.x);
	pd->objPos.v.c.y = INTEL_INT (pd->objPos.v.c.y);
	pd->objPos.v.c.z = INTEL_INT (pd->objPos.v.c.z);
	pd->objOrient.m.v.r.v.c.x = (fix)INTEL_INT ((int)pd->objOrient.m.v.r.v.c.x);
	pd->objOrient.m.v.r.v.c.y = (fix)INTEL_INT ((int)pd->objOrient.m.v.r.v.c.y);
	pd->objOrient.m.v.r.v.c.z = (fix)INTEL_INT ((int)pd->objOrient.m.v.r.v.c.z);
	pd->objOrient.m.v.u.v.c.x = (fix)INTEL_INT ((int)pd->objOrient.m.v.u.v.c.x);
	pd->objOrient.m.v.u.v.c.y = (fix)INTEL_INT ((int)pd->objOrient.m.v.u.v.c.y);
	pd->objOrient.m.v.u.v.c.z = (fix)INTEL_INT ((int)pd->objOrient.m.v.u.v.c.z);
	pd->objOrient.m.v.f.v.c.x = (fix)INTEL_INT ((int)pd->objOrient.m.v.f.v.c.x);
	pd->objOrient.m.v.f.v.c.y = (fix)INTEL_INT ((int)pd->objOrient.m.v.f.v.c.y);
	pd->objOrient.m.v.f.v.c.z = (fix)INTEL_INT ((int)pd->objOrient.m.v.f.v.c.z);
	pd->physVelocity.v.c.x = (fix)INTEL_INT ((int)pd->physVelocity.v.c.x);
	pd->physVelocity.v.c.y = (fix)INTEL_INT ((int)pd->physVelocity.v.c.y);
	pd->physVelocity.v.c.z = (fix)INTEL_INT ((int)pd->physVelocity.v.c.z);
	pd->physRotVel.v.c.x = (fix)INTEL_INT ((int)pd->physRotVel.v.c.x);
	pd->physRotVel.v.c.y = (fix)INTEL_INT ((int)pd->physRotVel.v.c.y);
	pd->physRotVel.v.c.z = (fix)INTEL_INT ((int)pd->physRotVel.v.c.z);
