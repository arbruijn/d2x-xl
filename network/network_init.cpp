...
networkData.nSyncState = 0;				// Are we in the process of sending OBJECTS to a tPlayer?
...
networkData.bSendObjectMode = 0;			// What nType of OBJECTS are we sending, static or dynamic?
