...
void DigiGetSoundLoc( vmsMatrix * listener, vmsVector * listener_pos, int listener_seg, vmsVector * sound_pos, int sound_seg, fix maxVolume, int *volume, int *pan, fix maxDistance )
{	  
