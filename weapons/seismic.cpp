...
if (gameData.escort.nObjNum != -1) {
	gameData.Object (gameData.escort.nObjNum)->mType.physInfo.rotVel.v.coord.x += rx * 4;
	gameData.Object (gameData.escort.nObjNum)->mType.physInfo.rotVel.v.coord.z += rz * 4;
	}
