...
rotangs = CAngleVector::Create((fixang) FixMul (mType.spinRate.v.c.x, gameData.time.xFrame),
										 (fixang) FixMul (mType.spinRate.v.c.y, gameData.time.xFrame),
										 (fixang) FixMul (mType.spinRate.v.c.z, gameData.time.xFrame));
